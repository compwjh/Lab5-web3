...
// Construct web3 instance and account under Rinkeby provider
const web3Instance = new web3('https://rinkeby.infura.io/v3/' + secret.node)
...
async function deploy() {
  ...
  // Send the transaction to Rinkeby network via Infrua node
...
async function interact() {
  ...
  console.log(`The deployed contract can been viewed at: https://rinkeby.etherscan.io/address/${address}`)
